...
Recuerde realizar el {\itshape pull request} al repositorio original una vez completada la práctica.\hypertarget{md__r_e_a_d_m_e_autotoc_md0}{}\doxysection{Ejercicios básicos}\label{md__r_e_a_d_m_e_autotoc_md0}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md1}{}\doxysection{Ejercicios de ampliación}\label{md__r_e_a_d_m_e_autotoc_md1}
...
Encontrará más información acerca de estas técnicas en las \href{https://atenea.upc.edu/pluginfile.php/2908770/mod_resource/content/3/2b_PS Techniques.pdf}{\texttt{ Transparencias del Curso}} y en \href{https://discovery.upc.edu/iii/encore/record/C__Rb1233593?lang=cat}{\texttt{ Spoken Language Processing}}. También encontrará más información en los anexos del enunciado de esta práctica.
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md2}{}\doxysection{Evaluación $<$em$>$ciega$<$/em$>$ del detector}\label{md__r_e_a_d_m_e_autotoc_md2}
